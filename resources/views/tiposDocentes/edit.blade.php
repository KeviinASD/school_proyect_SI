    ...
    <div class="container mx-auto py-8">
        ...
        <form action="{{ route('tiposDocentes.update', $tipoDocente->id_tipo_docente) }}" method="POST" class="max-w-lg mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="nombreTipo" name="nombreTipo" value="{{ $tipoDocente->nombreTipo }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            </div>
